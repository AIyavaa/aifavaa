...
const content = {
  zh: {
    ...
    desc: '从个人创作者到高净值投资者，从家庭记忆守护者到全球商业合伙人——AIyavaa 的四位一体架构服务于每一类数字时代的参与者。',
    groups: [
      {
        icon: '🎨',
        tag: 'Create',
        title: '内容创作者与创意工作者',
        desc: '视频创作者、音乐人、主播、播客、摄影师、设计师——任何有创意的人都能通过 AIyavaa 将想法变为可交易的数字资产。',
      ...
      },
      {
        ...
        tag: 'Earn',
        title: '高净值投资者与财富管理者',
        desc: '需要管理 AI 资产、RWA 真实世界资产、另类资产的高净值客户与家族办公室——AIyavaa Wealth OS 是专为他们设计的智能财富管理平台。',
      ...
      },
      {
        ...
        tag: 'Partner',
        title: '全球商业合伙人',
        desc: '通过合伙人体系参与 AIyavaa 生态建设的个人与机构——分享合伙人、城市合伙人、国家合伙人、垂直行业合伙人。',
    ...
    cta: '无论你是谁，AIyavaa 都为你准备了一个位置。',
  },
  en: {
    badge: '05 / Who Uses It',
    title: 'Who Uses AIyavaa?',
    subtitle: 'Create · Own · Trade · Earn — For Everyone',
    desc: "From individual creators to high-net-worth investors, from family memory keepers to global business partners — AIyavaa's four-in-one architecture serves every participant in the digital age.",
    groups: [
      {
        icon: '🎨',
        tag: 'Create',
        title: 'Content Creators & Creative Professionals',
        desc: 'Video creators, musicians, streamers, podcasters, photographers, designers — anyone with creativity can turn ideas into tradeable digital assets through AIyavaa.',
      ...
      },
      {
        ...
        desc: "High-net-worth clients and family offices who need to manage AI assets, RWA real-world assets, and alternative assets — AIyavaa Wealth OS is the intelligent wealth management platform designed for them.",
      ...
      },
      {
        ...
        desc: 'Individuals and institutions participating in AIyavaa ecosystem building through the partner system — sharing partners, city partners, country partners, vertical industry partners.',
    ...
    cta: 'Whoever you are, AIyavaa has a place for you.',
  },
};
