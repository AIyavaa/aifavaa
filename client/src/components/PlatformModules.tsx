  ...
  zh: {
    ...
    modules: [
      ...
      },
      {
        ...
        desc: '用户在 AIyavaa 或任何软件平台上使用 AI 生成图片、视频、音乐、APP、游戏、小说，选择 AIyavaa 确权功能，系统自动判定并生成：时间戳、区块链登记、作者认证、收益追踪。AIyavaa 不仅帮助用户创造 AI 资产，还帮助完成确权、估值、交易、融资和收益分配，形成完整的 AI 资产金融生态。',
      ...
      },
      {
        ...
        desc: '未来：每个商人都可以在 AIyavaa 拥有独立的 AI 员工。财务 AI、法律 AI、HR AI、营销 AI、股票 AI、教育培训 AI、顾问 AI——按需订阅，即插即用。',
      ...
      },
      {
        ...
        num: '8.6',
        icon: '💰',
        label: 'AIyavaa Wealth Copilot',
        title: 'AI 财富管理副驾驶',
        tagline: '全球首个 AI 财富管理操作系统',
        desc: '打造 AI 时代的财富管理基础设施平台。AIyavaa Wealth OS 解决方案——AI Wealth Brain 财富大脑——为高净值客户、家族办公室和金融机构提供全资产 AI 管理、另类资产中心、RWA 代币化和智能增值服务。',
  ...
  en: {
    ...
    modules: [
      ...
      },
      {
        ...
        desc: 'When users generate images, videos, music, apps, games, or novels using AI on AIyavaa or any platform, selecting AIyavaa\'s ownership function automatically creates: timestamp, blockchain registration, author certification, revenue tracking. AIyavaa not only helps users create AI assets, but also completes ownership, valuation, trading, financing, and revenue distribution — forming a complete AI asset financial ecosystem.',
      ...
      },
      {
        ...
        icon: '🤖',
        label: 'AI Agent Marketplace',
        title: 'AIyavaa Agent Marketplace',
        tagline: 'Like Apple App Store — every business owner has AI employees',
        desc: 'In the future: every business owner can have dedicated AI employees on AIyavaa. Finance AI, Legal AI, HR AI, Marketing AI, Stock AI, Education & Training AI, Advisor AI — subscribe on demand, plug and play.',
      ...
      },
      {
        ...
        desc: 'Building the wealth management infrastructure platform for the AI era. AIyavaa Wealth OS solution — AI Wealth Brain — provides HNW clients, family offices, and financial institutions with total asset AI management, alternative asset hub, RWA tokenization, and intelligent appreciation services.',
    ...
    closingTitle: 'Create → Own → Trade → Wealth Manage → Earn',
    closingDesc: 'AIyavaa forms a complete AI ecosystem loop: Create → Own → Trade → Wealth Manage → Earn',
  },
};
